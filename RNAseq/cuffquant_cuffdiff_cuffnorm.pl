...
sub runCuffdiff($$$$$$$$$$$$$$$$$$$){
	my($extraPathsRequired,$cufflinksPath,$samtoolsPath,$cuffquantOutDir,$cuffdiffOutDir,$GTF,$cuffdiffLibraryType,$cuffdiffNThreads,
		$cuffdiffFragBiasCorrect,$cuffdiffMultiReadCorrect,$cuffdiffMinAlignmentCount,$cuffdiffSeed,
		$cuffdiffInputFiles,$referenceSequence,$cuffdiffFDR,$cuffdiffLibraryNormalizationMethod,$cuffdiffComparisonLabels,$FPKMthreshold,$cuffdiffMaxBundleFrags)=@_;
	...
	&cuffquant_cuffdiff_cuffnorm::createExcel($cuffdiffOutDir,$cuffdiffFDR,$cuffdiffComparisonLabels,$FPKMthreshold);
